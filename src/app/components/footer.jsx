...
export default function Footer() {
  ...
  return (
    <div>
      <div className="flex justify-around p-[100px] bg-blue-100">
        <div className="flex flex-col justify-center items-center">
          <div className="  w-[100px] bg-blue-300 rounded-[50%] px-2 py-2 flex justify-center">
            <div className="bg-blue-600 rounded-[50%] w-[82px] h-[80px] flex justify-center items-center">
      ...
      <div className="bg-blue-400 flex justify-around footer-info p-12">
